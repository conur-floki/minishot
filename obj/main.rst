...
Hexadecimal [16-Bits]
                             ...
                             13 .globl cpct_scanKeyboard_asm
                             14 .globl cpct_isKeyPressed_asm
                             15 .globl _g_palette
                             16 .globl _sp_player_ship
                             17 .globl _sp_enemy_ship
                             18 .globl _sp_bullet
                             19 
                     0006    20 SP_PLAYER_SHIP_W = 6
                     000E    21 SP_PLAYER_SHIP_H = 14
                     000D    22 SP_ENEMY_SHIP_W = 13
                     0010    23 SP_ENEMY_SHIP_H = 16
                     0001    24 SP_BULLET_W = 1
                     0008    25 SP_BULLET_H = 8
                             26 
                     0000    27 FALSE = 0
                     0001    28 TRUE = 1 
                     0025    29 PLAYER_X = 37
                     00BA    30 PLAYER_Y = 200 - SP_PLAYER_SHIP_H
                     0043    31 ENEMY_INIT_X = 80 - SP_ENEMY_SHIP_W
                     000A    32 ENEMY_Y = 10
                     FFFFFFFF    33 ENEMY_VX = -1
                     0027    34 BULLET_X = PLAYER_X + 2
                     00B2    35 BULLET_INIT_Y = PLAYER_Y - SP_BULLET_H
                     FFFFFFFE    36 BULLET_VY = -2
                             37 
                     0000    38 enemy_x = 0
                     0001    39 bullet_y = 1
                     0002    40 bullet_on = 2
                     0003    41 reserve_byte = 3
                             42 
   413C                      43 drawPlayer:
   413C 11 00 C0      [10]   44     ld de, #CPCT_VMEM_START_ASM
   413F 0E 25         [ 7]   45     ld c, #PLAYER_X
   4141 06 BA         [ 7]   46     ld b, #PLAYER_Y
   4143 CD E0 43      [17]   47     call cpct_getScreenPtr_asm
                             48    
   4146 EB            [ 4]   49     ex de, hl
   4147 21 D8 40      [10]   50     ld hl, #_sp_player_ship
   414A 06 0E         [ 7]   51     ld b, #SP_PLAYER_SHIP_H
   414C 0E 06         [ 7]   52     ld c, #SP_PLAYER_SHIP_W
   414E CD 6D 42      [17]   53     call cpct_drawSprite_asm
                             54 
   4151 C9            [10]   55     ret
                             56 
   4152                      57 drawEnemy:
   4152 11 00 C0      [10]   58     ld de, #CPCT_VMEM_START_ASM
   4155 06 0A         [ 7]   59     ld b, #ENEMY_Y
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 96.
Hexadecimal [16-Bits]



   4157 CD E0 43      [17]   60     call cpct_getScreenPtr_asm
                             61    
   415A EB            [ 4]   62     ex de, hl
   415B 21 08 40      [10]   63     ld hl, #_sp_enemy_ship
   415E 06 10         [ 7]   64     ld b, #SP_ENEMY_SHIP_H
   4160 0E 0D         [ 7]   65     ld c, #SP_ENEMY_SHIP_W
   4162 CD 6D 42      [17]   66     call cpct_drawSprite_asm
                             67 
   4165 C9            [10]   68     ret
                             69 
   4166                      70 eraseEnemy:
   4166 11 00 C0      [10]   71     ld de, #CPCT_VMEM_START_ASM
   4169 06 0A         [ 7]   72     ld b, #ENEMY_Y
   416B CD E0 43      [17]   73     call cpct_getScreenPtr_asm
                             74    
   416E EB            [ 4]   75     ex de, hl
   416F 3E 00         [ 7]   76     ld a, #0
   4171 06 10         [ 7]   77     ld b, #SP_ENEMY_SHIP_H
   4173 0E 0D         [ 7]   78     ld c, #SP_ENEMY_SHIP_W
   4175 CD 3C 43      [17]   79     call cpct_drawSolidBox_asm
                             80 
   4178 C9            [10]   81     ret    
                             82 
                             83 ;;;;
                             ...
                             85 ;;;;
   4179                      86 drawBullet:
   4179 11 00 C0      [10]   87     ld de, #CPCT_VMEM_START_ASM
   417C 0E 27         [ 7]   88     ld c, #BULLET_X
   417E CD E0 43      [17]   89     call cpct_getScreenPtr_asm
                             90    
   4181 EB            [ 4]   91     ex de, hl
   4182 21 00 40      [10]   92     ld hl, #_sp_bullet
   4185 06 08         [ 7]   93     ld b, #SP_BULLET_H
   4187 0E 01         [ 7]   94     ld c, #SP_BULLET_W
   4189 CD 6D 42      [17]   95     call cpct_drawSprite_asm
                             96 
   418C C9            [10]   97     ret
                             98 
   418D                      99 eraseBullet:
   418D 11 00 C0      [10]  100     ld de, #CPCT_VMEM_START_ASM
   4190 0E 27         [ 7]  101     ld c, #BULLET_X
   4192 CD E0 43      [17]  102     call cpct_getScreenPtr_asm
                            103    
   4195 EB            [ 4]  104     ex de, hl
   4196 3E 00         [ 7]  105     ld a, #0
   4198 06 08         [ 7]  106     ld b, #SP_BULLET_H
   419A 0E 01         [ 7]  107     ld c, #SP_BULLET_W
   419C CD 3C 43      [17]  108     call cpct_drawSolidBox_asm
                            109 
   419F C9            [10]  110     ret 
                            111 
   41A0                     112 _main::
   41A0 DD 21 FD FF   [14]  113     ld ix, #-reserve_byte
   41A4 DD 39         [15]  114     add ix, sp
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 97.
Hexadecimal [16-Bits]



   41A6 DD F9         [10]  115     ld sp, ix
                            116 
   41A8 DD 36 00 43   [19]  117     ld enemy_x(ix), #ENEMY_INIT_X
   41AC DD 36 01 B2   [19]  118     ld bullet_y(ix), #BULLET_INIT_Y
   41B0 DD 36 02 01   [19]  119     ld bullet_on(ix), #TRUE
                            120 
   41B4 CD 2C 43      [17]  121     call cpct_disableFirmware_asm
                            122     
   41B7 0E 00         [ 7]  123     ld c, #0
   41B9 CD 17 43      [17]  124     call cpct_setVideoMode_asm
                            125     
   41BC 21 2C 41      [10]  126     ld hl, #_g_palette
   41BF 11 10 00      [10]  127     ld de, #16
   41C2 CD 44 42      [17]  128     call cpct_setPalette_asm
   0089                     129     cpctm_setBorder_asm HW_BLACK
                              1    .radix h
   0089                       2    cpctm_setBorder_raw_asm \HW_BLACK ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   41C5 21 10 14      [10]    2    ld   hl, #0x1410         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   41C8 CD 63 42      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
                            130     
   41CB                     131 loop:
                            132     
   41CB DD 7E 00      [19]  133     ld a, enemy_x(ix)
   41CE FE 00         [ 7]  134     cp #0
   41D0 28 08         [12]  135     jr z, draw_enemy_at_0
   41D2 DD 4E 00      [19]  136         ld c, enemy_x(ix)
   41D5 CD 52 41      [17]  137         call drawEnemy
   41D8 18 06         [12]  138         jr draw_enemy_end_if
                            139 
   41DA                     140         draw_enemy_at_0:   
   41DA DD 4E 00      [19]  141             ld c, enemy_x(ix)
   41DD CD 66 41      [17]  142             call eraseEnemy
                            143     
   41E0                     144     draw_enemy_end_if:
                            145 
   41E0 CD 3C 41      [17]  146     call drawPlayer
                            147 
   41E3 DD 7E 02      [19]  148     ld a, bullet_on(ix)
   41E6 FE 00         [ 7]  149     cp #FALSE
   41E8 28 15         [12]  150     jr z, endif_draw_bullet
   41EA DD 7E 01      [19]  151         ld a, bullet_y(ix)
   41ED FE 00         [ 7]  152         cp #0
   41EF 28 08         [12]  153         jr z, else_draw_bullet_in
                            154 
   41F1 DD 46 01      [19]  155         ld b, bullet_y(ix)
   41F4 CD 79 41      [17]  156         call drawBullet
   41F7 18 06         [12]  157         jr  endif_draw_bullet
                            158         
   41F9                     159             else_draw_bullet_in:
   41F9 DD 46 01      [19]  160                 ld b, bullet_y(ix)
   41FC CD 8D 41      [17]  161                 call eraseBullet
                            162 
   41FF                     163     endif_draw_bullet:
...
Hexadecimal [16-Bits]
                            ...
                            164 
   41FF DD 7E 02      [19]  165     ld a, bullet_on(ix)
   4202 FE 00         [ 7]  166     cp #FALSE
   4204 28 14         [12]  167     jr z, else_updatebullet_on
   4206 DD 7E 01      [19]  168         ld a, bullet_y(ix)
   4209 FE 00         [ 7]  169         cp #0
   420B 28 07         [12]  170         jr z, else_bullet_update
                            171             ;;ld a, bullet_y(ix) a is already loaded
   420D C6 FE         [ 7]  172             add #BULLET_VY
   420F DD 77 01      [19]  173             ld bullet_y(ix), a
   4212 18 06         [12]  174             jr endif_bullet_update
                            175 
   4214                     176         else_bullet_update:
   4214 DD 36 02 00   [19]  177             ld bullet_on(ix), #FALSE
   4218 18 10         [12]  178             jr endif_updatebullet_on
                            179 
   421A                     180         endif_bullet_update:    
                            181     
   421A                     182     else_updatebullet_on:
   421A 21 05 80      [10]  183         ld hl, #Key_Space
   421D CD 57 42      [17]  184         call cpct_isKeyPressed_asm
   4220 28 08         [12]  185         jr z, endif_updatebullet_on
   4222 DD 36 02 01   [19]  186             ld bullet_on(ix), #TRUE
   4226 DD 36 01 B2   [19]  187             ld bullet_y(ix), #BULLET_INIT_Y
                            188 
   422A                     189     endif_updatebullet_on:
                            190 
   422A DD 7E 00      [19]  191     ld a, enemy_x(ix)
   422D FE 00         [ 7]  192     cp #0
   422F 28 07         [12]  193     jr z, else_enemy_update
                            194         ;; enemy_x != 0
   4231 C6 FF         [ 7]  195         add #ENEMY_VX
   4233 DD 77 00      [19]  196         ld enemy_x(ix), a
   4236 18 04         [12]  197         jr enemy_is_at_end_if
                            198 
                            199     ;; enemy_x != 0
   4238                     200     else_enemy_update:
   4238 DD 36 00 43   [19]  201         ld enemy_x(ix), #ENEMY_INIT_X
                            202 
   423C                     203     enemy_is_at_end_if:
                            204     
   423C CD F2 43      [17]  205     call cpct_scanKeyboard_asm
   423F CD 24 43      [17]  206     call cpct_waitVSYNC_asm
                            207 
   4242 18 87         [12]  208     jr loop
